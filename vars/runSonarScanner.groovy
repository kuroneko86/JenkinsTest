def call(String sonarLogin) {
    ...
    def execSonar = steps.sh(script: "sonar-scanner-8.0.1.6346-linux-x64/bin/sonar-scanner -Dsonar.host.url=http://192.168.10.37:9000 -Dsonar.login=${sonarLogin}", returnStdout: true)
    println execSonar
